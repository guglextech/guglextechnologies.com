---
title: "Approve the MoMo PIN when buying a WASSCE checker on Ewale"
excerpt: "The USSD session can close while the mobile money prompt is still open. Approve it. That prompt is what pays for the WASSCE checker."
date: "2026-03-26"
...
The USSD session can close while the mobile money prompt is still open. Approve it. That prompt is what pays for the WASSCE checker.

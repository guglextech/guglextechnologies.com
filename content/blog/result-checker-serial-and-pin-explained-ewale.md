---
title: "Result checker serial and PIN explained"
excerpt: "Serial identifies the voucher. PIN authorises one check (rules depend on WAEC). Ewale sends both when you finish buying a result checker."
date: "2026-05-17"
...
Serial identifies the voucher. PIN authorises one check (rules depend on WAEC). Ewale sends both when you finish buying a result checker.
